...
source: "https://platform.claude.com/docs/en/build-with-claude/rate-limits-api"
category: "developer"
generated: true
---
# Rate Limits API
...
- **Power internal alerting:** Compare usage data from the [Usage and Cost API](./developer-build-with-claude-usage-cost-api.md) against your configured limits.
...
The `/v1/organizations/rate_limits` endpoint returns the rate limits applied at the organization level for the Messages API and its supporting resources. Limits for other products, such as [Claude Managed Agents](./developer-managed-agents-overview.md), are not included.
...
For complete parameter details and response schemas, see the [Organization Rate Limits API reference](../api/api-admin-rate_limits-list.md).
