...
| **Learn more** | [Messages API docs](./developer-build-with-claude-working-with-messages.md) | [Claude Managed Agents docs](./developer-managed-agents-overview.md) |
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="play" href="./developer-managed-agents-quickstart.md">
    Create your first agent session
  </Card>
  <Card title="API Reference" icon="code-brackets" href="./developer-managed-agents-sessions.md">
...
See [Tools](./developer-managed-agents-tools.md) for the full list and configuration options.
...
Certain features ([outcomes](./developer-managed-agents-define-outcomes.md), [multiagent](./developer-managed-agents-multi-agent.md), and [memory](./developer-managed-agents-memory.md)) are in research preview. [Request access](https://claude.com/form/claude-managed-agents) to try them.
