...
Cloud containers include common runtimes out of the box. See [Container reference](./developer-managed-agents-cloud-containers.md) for the full list of pre-installed languages, databases, and utilities.