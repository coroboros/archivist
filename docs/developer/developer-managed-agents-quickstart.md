...
````
    ...
    The `agent_toolset_20260401` tool type enables the full set of pre-built agent tools (bash, file operations, web search, and more). See [Tools](./developer-managed-agents-tools.md) for the complete list and per-tool configuration options.
...
<CardGroup cols={2}>
  <Card title="Define your agent" icon="brain" href="./developer-managed-agents-agent-setup.md">
    Create reusable, versioned agent configurations
  </Card>
  <Card title="Configure environments" icon="settings" href="./developer-managed-agents-environments.md">
    Customize networking and container settings
  </Card>
  <Card title="Agent tools" icon="tool" href="./developer-managed-agents-tools.md">
    Enable specific tools for your agent
  </Card>
  <Card title="Events and streaming" icon="lightning" href="./developer-managed-agents-events-and-streaming.md">
