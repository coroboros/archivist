...
Claude is also available through [Amazon Bedrock](./developer-build-with-claude-claude-in-amazon-bedrock.md) and [Microsoft Foundry](./developer-build-with-claude-claude-in-microsoft-foundry.md).
...
Claude Opus 4.7, Claude Opus 4.6, and Claude Sonnet 4.6 have a [1M-token context window](./developer-build-with-claude-context-windows.md) on Vertex AI. Other Claude models, including Sonnet 4.5 and Sonnet 4 (deprecated), have a 200k-token context window.
