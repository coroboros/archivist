...
The `claude-api` skill is an open-source [Agent Skill](./developer-agents-and-tools-agent-skills-overview.md) that provides Claude with detailed, up-to-date reference material for building applications on two Anthropic surfaces:
...
- **Tool use guidance:** Language-specific examples and [conceptual foundations](./developer-agents-and-tools-tool-use-overview.md) for function calling, including the beta tool runner where available
...
- **Model migration:** Step-by-step guidance for migrating to newer Claude models (including the breaking changes and behavior shifts on [Claude Opus 4.7](./developer-about-claude-models-migration-guide.md#migrating-to-claude-opus-4-7))
...
- **Prefill replacement**, converting assistant-message prefill patterns to [structured outputs](./developer-build-with-claude-structured-outputs.md) where applicable
...
For the full list of model-specific changes the skill applies, see [Migrating to Claude Opus 4.7](./developer-about-claude-models-migration-guide.md#migrating-to-claude-opus-4-7).
