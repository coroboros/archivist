...
| **[Extended thinking](./developer-build-with-claude-extended-thinking.md)** | No | Yes | Yes |
...
_<sup>3 - Claude Opus 4.7 on AWS is available through [Claude in Amazon Bedrock](./developer-build-with-claude-claude-in-amazon-bedrock.md) (the Messages-API Bedrock endpoint).</sup>_
...
<Note>
The Max output values above apply to the synchronous Messages API. On the [Message Batches API](./developer-build-with-claude-batch-processing.md#extended-output-beta), Opus 4.7, Opus 4.6, and Sonnet 4.6 support up to 300k output tokens by using the `output-300k-2026-03-24` beta header.
</Note>
...
| **[Extended thinking](./developer-build-with-claude-extended-thinking.md)** | Yes | Yes | Yes | Yes | Yes | Yes |
...
<Warning>
Claude Sonnet 4 (`claude-sonnet-4-20250514`) and Claude Opus 4 (`claude-opus-4-20250514`) are deprecated and will be retired on June 15, 2026. Migrate to [Claude Sonnet 4.6](./developer-about-claude-models-overview.md#latest-models-comparison) and [Claude Opus 4.7](./developer-about-claude-models-overview.md#latest-models-comparison) respectively before the retirement date.

See [model deprecations](./developer-about-claude-model-deprecations.md) for details.
</Warning>
