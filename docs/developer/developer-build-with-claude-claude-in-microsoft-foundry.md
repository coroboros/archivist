...
Claude Opus 4.7, Claude Opus 4.6, and Claude Sonnet 4.6 have a [1M-token context window](./developer-build-with-claude-context-windows.md) on Microsoft Foundry. Other Claude models, including Sonnet 4.5, have a 200k-token context window.
