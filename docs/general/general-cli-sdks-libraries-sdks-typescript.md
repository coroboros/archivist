...
<Info>
  For API feature documentation with code examples, see the [API reference](../api/api-overview.md). This page covers TypeScript-specific SDK features and configuration.
</Info>
...
> For more information on debugging requests, see [Request ID](../api/api-errors.md#request-id).
...
You can access most beta API features through the beta property of the client. To enable a particular beta feature, you need to add the appropriate [beta header](../api/api-beta-headers.md) to the `betas` field when creating a message.
