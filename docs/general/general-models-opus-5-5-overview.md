...
[Announcement](https://www.anthropic.com/claude-opus-5-5) · [What’s new](./general-models-opus-5-5-whats-new-opus-5-5.md) · [Migration guide](./general-models-opus-5-5-migration-guide.md)
...
[What's new in Claude Opus 5.5](./general-models-opus-5-5-whats-new-opus-5-5.md)
...
| [Amazon Bedrock](../build-with-claude/build-with-claude-claude-in-amazon-bedrock.md)       | `anthropic.claude-opus-5-5` |
| [Google Cloud](../build-with-claude/build-with-claude-claude-on-vertex-ai.md)              | `claude-opus-5-5`           |
| [Microsoft Foundry](../build-with-claude/build-with-claude-claude-in-microsoft-foundry.md) | `claude-opus-5-5`           |
| [Claude Platform on AWS](../build-with-claude/build-with-claude-claude-platform-on-aws.md) | `claude-opus-5-5`           |
...
| Input                                                                                  | $4 / MTok                        |
| Output                                                                                 | $20 / MTok                       |
| [5m cache write](../build-with-claude/build-with-claude-prompt-caching.md) | $5 / MTok                        |
| [1h cache write](../build-with-claude/build-with-claude-prompt-caching.md) | $8 / MTok                        |
...
| [Default effort](../build-with-claude/build-with-claude-effort.md)                                              | `medium`               |
...
* Adaptive thinking is always on and can't be turned off. Control thinking depth with the [effort parameter](../build-with-claude/build-with-claude-effort.md).
* On the [Message Batches API](../build-with-claude/build-with-claude-batch-processing.md#extended-output-beta), Claude Opus 5.5 supports up to 300k output tokens with the `output-300k-2026-03-24` beta header.
...
<CardGroup cols={3}>
  <Card title="Prompting Claude Opus 5.5" icon="lightbulb" href="../build-with-claude/build-with-claude-prompt-engineering-prompting-claude-opus-5-5.md">
...
<CardGroup cols={3}>
  <Card title="System prompt" icon="text" href="../release-notes/release-notes-system-prompts-claude-opus-5-5.md">
