...
Although Claude Opus 4.8 is still available, you should consider migrating to Claude Opus 5.5 for improved performance. [See Claude Opus 5.5](https://platform.claude.com/docs/en/models/opus-5-5/overview.md) · [Migrate to Claude Opus 5.5](https://platform.claude.com/docs/en/models/opus-5-5/migration-guide.md)
...
| [Amazon Bedrock](../build-with-claude/build-with-claude-claude-in-amazon-bedrock.md)       | `anthropic.claude-opus-4-8` |
| [Google Cloud](../build-with-claude/build-with-claude-claude-on-vertex-ai.md)              | `claude-opus-4-8`           |
| [Microsoft Foundry](../build-with-claude/build-with-claude-claude-in-microsoft-foundry.md) | `claude-opus-4-8`           |
| [Claude Platform on AWS](../build-with-claude/build-with-claude-claude-platform-on-aws.md) | `claude-opus-4-8`           |
...
<CardGroup cols={3}>
  <Card title="Migrate to Claude Opus 5.5" icon="arrows-left-right" href="https://platform.claude.com/docs/en/models/opus-5-5/migration-guide.md">
    What changes when moving from Claude Opus 4.8 to Claude Opus 5.5.
  </Card>

  <Card title="Claude Opus 5.5" icon="arrow-right" href="https://platform.claude.com/docs/en/models/opus-5-5/overview.md">
    The current Opus model: overview, specs, and resources.
  </Card>

  <Card title="Prompting Claude Opus 4.8" icon="lightbulb" href="../build-with-claude/build-with-claude-prompt-engineering-prompting-claude-opus-4-8.md">
