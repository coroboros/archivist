...
If you're unsure which model to use, start with [Claude Opus 5](./general-models-opus-5-overview.md) for complex agentic coding and enterprise work; for the highest available capability, use [Claude Fable 5](./general-models-fable-5-overview.md). All current models support text and image input, text output, multilingual capabilities, vision, and tool use; each model’s page lists the platforms it is available on.
...
| Model page                                                                                                | [Claude Fable 5](./general-models-fable-5-overview.md) | [Claude Opus 5](./general-models-opus-5-overview.md) | [Claude Sonnet 5](./general-models-sonnet-5-overview.md) | [Claude Haiku 4.5](./general-models-haiku-4-5-overview.md) |
...
| [Retirement](../about-claude/about-claude-model-deprecations.md)                         | Not sooner than June 9, 2027                                                  | Not sooner than July 24, 2027                                               | Not sooner than June 30, 2027                                                   | Not sooner than October 15, 2026                                                  |
| Claude API alias                                                                                          | `claude-fable-5`                                                              | `claude-opus-5`                                                             | `claude-sonnet-5`                                                               | `claude-haiku-4-5`                                                                |
| [Amazon Bedrock ID](../build-with-claude/build-with-claude-claude-in-amazon-bedrock.md)       | `anthropic.claude-fable-5`                                                    | `anthropic.claude-opus-5`                                                   | `anthropic.claude-sonnet-5`                                                     | `anthropic.claude-haiku-4-5`                                                      |
| [Google Cloud ID](../build-with-claude/build-with-claude-claude-on-vertex-ai.md)              | `claude-fable-5`                                                              | `claude-opus-5`                                                             | `claude-sonnet-5`                                                               | `claude-haiku-4-5@20251001`                                                       |
| [Microsoft Foundry ID](../build-with-claude/build-with-claude-claude-in-microsoft-foundry.md) | `claude-fable-5`                                                              | `claude-opus-5`                                                             | `claude-sonnet-5`                                                               | `claude-haiku-4-5`                                                                |
| [Claude Platform on AWS ID](../build-with-claude/build-with-claude-claude-platform-on-aws.md) | `claude-fable-5`                                                              | —                                                                           | `claude-sonnet-5`                                                               | `claude-haiku-4-5`                                                                |
...
* **Output quality:** When migrating from a previous model generation, you may notice larger improvements in overall performance. If you're on Claude Opus 4.8 or earlier, see [Migrating to Claude Opus 5](../about-claude/about-claude-models-migration-guide.md#migrating-from-claude-opus-4-8-to-claude-opus-5).
