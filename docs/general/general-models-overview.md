...
| Model page                                                                                                | [Claude Fable 5.1](./general-models-fable-5-1-overview.md) | [Claude Opus 5.5](./general-models-opus-5-5-overview.md) | [Claude Sonnet 5](./general-models-sonnet-5-overview.md) | [Claude Haiku 4.5](./general-models-haiku-4-5-overview.md) |
...
* **Output quality:** When migrating from a previous model generation, you may notice larger improvements in overall performance. If you're on Claude Opus 5 or earlier, see [Migrating to Claude Opus 5.5](./general-models-opus-5-5-migration-guide.md).
