...
<Info>
  For the full API specification, see the [API reference](../api/api-overview.md).
</Info>

## CLI

<CardGroup cols={3}>
  <Card title="ant CLI" href="./general-cli-sdks-libraries-cli-quickstart.md">
...
<CardGroup cols={3}>
  <Card title="Python" href="./general-cli-sdks-libraries-sdks-python.md">
    Sync and async clients, Pydantic models
  </Card>

  <Card title="TypeScript" href="./general-cli-sdks-libraries-sdks-typescript.md">
    Node.js, Deno, Bun, and browser support
  </Card>

  <Card title="C#" href="./general-cli-sdks-libraries-sdks-csharp.md">
    .NET Standard 2.0+, IChatClient integration
  </Card>

  <Card title="Go" href="./general-cli-sdks-libraries-sdks-go.md">
    Context-based cancellation, functional options
  </Card>

  <Card title="Java" href="./general-cli-sdks-libraries-sdks-java.md">
    Builder pattern, CompletableFuture async
  </Card>

  <Card title="PHP" href="./general-cli-sdks-libraries-sdks-php.md">
    Value objects, builder pattern
  </Card>

  <Card title="Ruby" href="./general-cli-sdks-libraries-sdks-ruby.md">
...
<CardGroup cols={3}>
  <Card title="Apple Foundation Models" href="./general-cli-sdks-libraries-libraries-apple-foundation-models.md">
    Swift package for Apple's `LanguageModelSession` API
  </Card>

  <Card title="OpenAI SDK compatibility" href="./general-cli-sdks-libraries-libraries-openai-sdk.md">
...
<CardGroup cols={3}>
  ...
  <Card title="Claude Managed Agents" href="../managed-agents/managed-agents-overview.md">
