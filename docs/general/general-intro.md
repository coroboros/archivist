---
title: "Explore the latest generation of Claude models"
...
* [Claude Fable 5.1](./general-models-fable-5-1-overview.md) (`claude-fable-5-1`) — New — *For demanding reasoning and long-horizon agentic work* — Most capable · Research · Multi-day tasks
* [Claude Opus 5.5](https://platform.claude.com/docs/en/models/opus-5-5/overview.md) (`claude-opus-5-5`) — New — *For long-running agentic coding and knowledge work* — Complex projects · Agents · Coding
* [Claude Sonnet 5](./general-models-sonnet-5-overview.md) (`claude-sonnet-5`) — *The best combination of speed and intelligence* — Everyday tasks · Writing · Cost-efficient
* [Claude Haiku 4.5](./general-models-haiku-4-5-overview.md) (`claude-haiku-4-5`) — *The fastest model with near-frontier intelligence* — Fastest · Lowest cost · High volume

[Compare models](./general-models-overview.md)
...
<Steps>
  ...
  <Step title="Understand the Messages API">
    ...
    [Read the Messages API guide](../build-with-claude/build-with-claude-working-with-messages.md)
  </Step>

  <Step title="Choose the right model">
    Compare Claude models by capability and cost to pick the best fit for your use case.

    [See the models overview](./general-models-overview.md)
  </Step>
...
<CardGroup cols={2}>
  <Card title="Text and code generation" icon="text-aa" href="../build-with-claude/build-with-claude-overview.md">
    Summarize text, answer questions, extract data, translate text, and explain and generate code.
  </Card>

  <Card title="Vision" icon="image" href="../build-with-claude/build-with-claude-vision.md">
