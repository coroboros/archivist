...
<Info>
  For API feature documentation with code examples, see the [API reference](../api/api-overview.md). This page covers Ruby-specific SDK features and configuration.
</Info>
...
For complete structured outputs documentation including Ruby examples, see [Structured outputs](../build-with-claude/build-with-claude-structured-outputs.md).
