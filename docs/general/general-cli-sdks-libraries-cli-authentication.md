...
By default, `ant auth login` requests a workspace-scoped token. To manage the resources documented on the [Admin API](../manage-claude/manage-claude-admin-api.md) page, request the `org:admin` scope under a dedicated profile:
...
For the profile file schema and the federation block, see [Profile configuration file](../manage-claude/manage-claude-wif-reference.md#profile-configuration-file). For Workload Identity Federation, see the [Authentication overview](../manage-claude/manage-claude-authentication.md) and the [WIF reference](../manage-claude/manage-claude-wif-reference.md).

## Next steps

<CardGroup cols={3}>
  <Card title="Using the CLI" icon="terminal" href="./general-cli-sdks-libraries-cli-using.md">
  ...
  <Card title="Workload Identity Federation" icon="cloud" href="../manage-claude/manage-claude-workload-identity-federation.md">
