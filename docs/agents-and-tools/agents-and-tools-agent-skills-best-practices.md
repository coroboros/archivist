...
The [context window](../build-with-claude/build-with-claude-context-windows.md) is a public good. Your Skill shares the context window with everything else Claude needs to know, including:
...
<CardGroup cols={2}>
  <Card title="Get started with Agent Skills" icon="rocket" href="./agents-and-tools-agent-skills-quickstart.md">
  ...
  <Card title="Use Skills with the API" icon="code" href="../build-with-claude/build-with-claude-skills-guide.md">
