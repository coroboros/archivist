...
<Steps>
  ...
  <Step title="Deploy">
    Upload through the Skills API for workspace-wide access. See [Using Skills with the API](../build-with-claude/build-with-claude-skills-guide.md) for upload and version management. Document the Skill in your internal registry with purpose, owner, and version.
  </Step>
...
The Skills API provides workspace-scoped distribution. Skills uploaded through the API are available to all workspace members. See [Using Skills with the API](../build-with-claude/build-with-claude-skills-guide.md) for upload, versioning, and management endpoints.
...
<CardGroup cols={2}>
  <Card title="Agent Skills overview" icon="book-open" href="./agents-and-tools-agent-skills-overview.md">
    Architecture and platform details
  </Card>

  <Card title="Best practices" icon="lightbulb" href="./agents-and-tools-agent-skills-best-practices.md">
    Authoring guidance for Skill creators
  </Card>

  <Card title="Using Skills with the API" icon="code" href="../build-with-claude/build-with-claude-skills-guide.md">
