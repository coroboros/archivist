...
All server tools support batch processing. See [Batch processing](../build-with-claude/build-with-claude-batch-processing.md).

## Next steps

<CardGroup cols={2}>
  <Card title="Web search" icon="magnifying-glass" href="./agents-and-tools-tool-use-web-search-tool.md">
    Search the web and cite results.
  </Card>
  <Card title="Web fetch" icon="globe" href="./agents-and-tools-tool-use-web-fetch-tool.md">
    Retrieve content from specific URLs.
  </Card>
  <Card title="Code execution" icon="terminal" href="./agents-and-tools-tool-use-code-execution-tool.md">
    Run Python in a sandboxed container.
  </Card>
  <Card title="Tool search" icon="list-magnifying-glass" href="./agents-and-tools-tool-use-tool-search-tool.md">
