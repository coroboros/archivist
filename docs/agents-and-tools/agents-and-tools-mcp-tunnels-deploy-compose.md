  ...
  <Tab title="With programmatic access">
    ...
    <Steps>
      ...
      <Step title="Provision the tunnel">
        Set the identifiers. Leave `TUNNEL_ID` unset to have the setup component create a tunnel; set it to attach to an existing tunnel from the [Console](./agents-and-tools-mcp-tunnels-console.md#create-a-tunnel):
