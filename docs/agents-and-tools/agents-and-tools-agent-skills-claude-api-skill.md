...
* **Model migration:** Step-by-step guidance for migrating to newer Claude models (including the breaking changes and behavior shifts on [Claude Opus 5](../general/general-models-opus-5-migration-guide.md#migrating-from-claude-opus-4-8-to-claude-opus-5) and [Claude Fable 5.1](../general/general-models-fable-5-1-migration-guide.md))
...
* **Deployment constraints:** Managed Agents is available on the Claude API and [Claude Platform on AWS](../build-with-claude/build-with-claude-claude-platform-on-aws.md) only (not on Amazon Bedrock, Google Cloud, or Microsoft Foundry). The skill routes other deployments to the Messages API and tool use instead.
...
For the full list of model-specific changes the skill applies, see [Migrating to Claude Opus 5 from Claude Opus 4.8](../general/general-models-opus-5-migration-guide.md#migrating-from-claude-opus-4-8-to-claude-opus-5) and [Migrating to Claude Fable 5.1](../general/general-models-fable-5-1-migration-guide.md).
...
<CardGroup cols={2}>
  <Card title="Agent Skills overview" icon="graduation-cap" href="./agents-and-tools-agent-skills-overview.md">
