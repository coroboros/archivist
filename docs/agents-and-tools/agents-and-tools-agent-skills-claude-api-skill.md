...
* **Model migration:** Step-by-step guidance for migrating to newer Claude models (including the breaking changes and behavior shifts on [Claude Opus 5](../about-claude/about-claude-models-migration-guide.md#migrating-from-claude-opus-4-8-to-claude-opus-5))
...
For the full list of model-specific changes the skill applies, see [Migrating to Claude Opus 5 from Claude Opus 4.8](../about-claude/about-claude-models-migration-guide.md#migrating-from-claude-opus-4-8-to-claude-opus-5).
