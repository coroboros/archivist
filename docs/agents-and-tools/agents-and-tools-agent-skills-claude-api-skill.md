...
For the full list of model-specific changes the skill applies, see [Migrating to Claude Opus 4.8 from Claude Opus 4.7](../about-claude/about-claude-models-migration-guide.md#migrating-from-claude-opus-47).
