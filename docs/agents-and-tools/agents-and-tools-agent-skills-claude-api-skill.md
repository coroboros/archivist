...
- **Model migration:** Step-by-step guidance for migrating to newer Claude models (including the breaking changes and behavior shifts on [Claude Opus 4.8](../about-claude/about-claude-models-migration-guide.md#migrating-from-claude-opus-47))
...
For the full list of model-specific changes the skill applies, see [Migrating from Claude Opus 4.7 to Claude Opus 4.8](../about-claude/about-claude-models-migration-guide.md#migrating-from-claude-opus-47).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="graduation-cap"
    href="./agents-and-tools-agent-skills-overview.md"
  >
  ...
  <Card
    title="Client SDKs"
    icon="code"
    href="https://platform.claude.com/docs/en/cli-sdks-libraries/overview.md"
  >
