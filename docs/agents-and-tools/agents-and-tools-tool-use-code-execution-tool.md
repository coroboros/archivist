...
| Claude Opus 4.1 (claude-opus-4-1-20250805) ([deprecated](../about-claude/about-claude-model-deprecations.md)) | `code_execution_20250825`                                                       |
...
* **Workspace scoping**: Like [Files](../build-with-claude/build-with-claude-files.md), containers are scoped to the workspace of the API key
