...
| Claude Opus 4.1 (claude-opus-4-1-20250805) (deprecated, see [Model deprecations](../about-claude/about-claude-model-deprecations.md)) | `code_execution_20250825`                                                       |
...
When Claude creates files during code execution, each created file's ID appears in the code execution tool result, and you can download it with the [Files API](../build-with-claude/build-with-claude-files.md):
