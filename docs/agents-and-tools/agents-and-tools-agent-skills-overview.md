...
**Pre-built Agent Skills** are available on claude.ai, the Claude API, [Claude Platform on AWS](../build-with-claude/build-with-claude-claude-platform-on-aws.md), and [Microsoft Foundry](../build-with-claude/build-with-claude-claude-in-microsoft-foundry.md). See [Available Skills](#available-skills) for the complete list.
...
To learn more, see [Use Skills with the Claude API](../build-with-claude/build-with-claude-skills-guide.md).
...
<CardGroup cols={2}>
  <Card title="Get started with Agent Skills" icon="graduation-cap" href="./agents-and-tools-agent-skills-quickstart.md">
    Create your first Skill
  </Card>

  <Card title="API Guide" icon="code" href="../build-with-claude/build-with-claude-skills-guide.md">
  ...
  <Card title="Authoring best practices" icon="lightbulb" href="./agents-and-tools-agent-skills-best-practices.md">
