...
Add a second header, `files-api-2025-04-14`, when you use the [Files API](../build-with-claude/build-with-claude-files.md) to upload input files to the container or download files a Skill produces.
