...
The memory tool pairs with context editing to manage long-running conversations. For details, see [Context editing](../build-with-claude/build-with-claude-context-editing.md).
...
<CardGroup cols={2}>
  ...
  <Card title="Context editing" icon="edit" href="../build-with-claude/build-with-claude-context-editing.md">
    Automatically manage conversation context as it grows with context editing.
  </Card>

  <Card title="Compaction" icon="stack" href="../build-with-claude/build-with-claude-compaction.md">
