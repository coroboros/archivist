...
| ----------------------------------------------------------------------------- | ---------------------------------------------------------------------- | --------- | ------------------------------------------------------------- |
| [Web search tool](./agents-and-tools-tool-use-web-search-tool.md)         | `web_search_20260209`<br/>`web_search_20250305`                        | Server    | GA                                                            |
| [Web fetch tool](./agents-and-tools-tool-use-web-fetch-tool.md)           | `web_fetch_20260209`<br/>`web_fetch_20250910`                          | Server    | GA                                                            |
| [Code execution tool](./agents-and-tools-tool-use-code-execution-tool.md) | `code_execution_20260120`<br/>`code_execution_20250825`                | Server    | GA                                                            |
