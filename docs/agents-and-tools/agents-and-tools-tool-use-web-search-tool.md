...
For continuing after a `pause_turn` stop reason, see [Server tools](./agents-and-tools-tool-use-server-tools.md#the-server-side-loop-and-pause-turn).
...
<CardGroup>
  <Card href="./agents-and-tools-tool-use-server-tools.md" title="Server tools">
