...
| **[Extended thinking](../build-with-claude/build-with-claude-extended-thinking.md)** | No | Yes | Yes |
| **[Adaptive thinking](../build-with-claude/build-with-claude-adaptive-thinking.md)** | Yes | Yes | No |
...
_<sup>1 - See the [pricing page](./about-claude-pricing.md) for complete pricing information including batch API discounts, prompt caching rates, extended thinking costs, and vision processing fees.</sup>_
...
_<sup>3 - Claude Opus 4.7 on AWS is available through [Claude in Amazon Bedrock](../build-with-claude/build-with-claude-claude-in-amazon-bedrock.md) (the Messages-API Bedrock endpoint).</sup>_
...
<Note>
The Max output values above apply to the synchronous Messages API. On the [Message Batches API](../build-with-claude/build-with-claude-batch-processing.md#extended-output-beta), Opus 4.7, Opus 4.6, and Sonnet 4.6 support up to 300k output tokens by using the `output-300k-2026-03-24` beta header.
</Note>
...
| **[Extended thinking](../build-with-claude/build-with-claude-extended-thinking.md)** | Yes | Yes | Yes | Yes | Yes | Yes |
| **[Priority Tier](../api/api-service-tiers.md)** | Yes | Yes | Yes | Yes | Yes | Yes |
...
- **Engaging responses**: Claude models are ideal for applications that require rich, human-like interactions.
    ...
    - For prompting best practices, see the [prompting best practices guide](../build-with-claude/build-with-claude-prompt-engineering-claude-prompting-best-practices.md).
...
<CardGroup cols={3}>
  <Card title="Intro to Claude" icon="check" href="../general/general-intro.md">
