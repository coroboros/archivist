...
- **Speed:** How quickly does the model need to respond in your application? For Claude Opus 4.6, [fast mode](../build-with-claude/build-with-claude-fast-mode.md) (beta: research preview) can provide up to 2.5x higher output speed at premium pricing.
...
1. [Create benchmark tests](../test-and-evaluate/test-and-evaluate-develop-tests.md) specific to your use case - having a good evaluation set is the most important step in the process
...
<CardGroup cols={3}>
  ...
  <Card title="What's new in Claude Opus 4.7" icon="sparkle" href="./about-claude-models-whats-new-claude-4-7.md">
