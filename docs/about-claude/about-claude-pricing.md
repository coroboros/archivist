...
Claude models are available on [AWS Bedrock](../build-with-claude/build-with-claude-claude-in-amazon-bedrock.md), [Google Vertex AI](../build-with-claude/build-with-claude-claude-on-vertex-ai.md), and [Microsoft Foundry](../build-with-claude/build-with-claude-claude-in-microsoft-foundry.md). For official pricing, visit:
...
- [AWS Bedrock global vs regional endpoints](../build-with-claude/build-with-claude-claude-in-amazon-bedrock.md#regions) for Opus 4.7, Haiku 4.5, and newer models, or [the legacy integration](../build-with-claude/build-with-claude-claude-on-amazon-bedrock-legacy.md#global-vs-regional-endpoints) for all other models on Bedrock
- [Google Vertex AI global, multi-region, and regional endpoints](../build-with-claude/build-with-claude-claude-on-vertex-ai.md#global-multi-region-and-regional-endpoints)
</Note>
...
For implementation details, supported models, and code examples, see the [prompt caching documentation](../build-with-claude/build-with-claude-prompt-caching.md).
...
For more information, see the [fast mode documentation](../build-with-claude/build-with-claude-fast-mode.md).
...
For more information about batch processing, see the [batch processing documentation](../build-with-claude/build-with-claude-batch-processing.md).
...
For more information about tool use implementation and best practices, see the [tool use documentation](../agents-and-tools/agents-and-tools-tool-use-overview.md).
...
Computer use follows the standard [tool use pricing](../agents-and-tools/agents-and-tools-tool-use-overview.md#pricing). When using the computer use tool:
...
- Screenshot images (see [Vision pricing](../build-with-claude/build-with-claude-vision.md))
...
[Claude Managed Agents](../managed-agents/managed-agents-overview.md) is billed on two dimensions: tokens and session runtime.
