...
Work with your support team to [define clear success criteria](../test-and-evaluate/test-and-evaluate-develop-tests.md) with measurable benchmarks, thresholds, and goals.
...
It’s hard to know how well your prompt works without deploying it in a test production setting and [running evaluations](../test-and-evaluate/test-and-evaluate-develop-tests.md).
...
To run your evaluation, you need test cases to run it on. The rest of this guide assumes you have already [developed your test cases](../test-and-evaluate/test-and-evaluate-develop-tests.md).
