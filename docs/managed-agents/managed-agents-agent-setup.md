...
| `model` | Required. The Claude [model](https://platform.claude.com/docs/en/about-claude/models/overview.md) that powers the agent. All Claude 4.5 and later models are supported. |
...
<Tip>
To use Claude Opus 4.6 with [fast mode](../build-with-claude/build-with-claude-fast-mode.md), pass `model` as an object: `{"id": "claude-opus-4-6", "speed": "fast"}`.
</Tip>
