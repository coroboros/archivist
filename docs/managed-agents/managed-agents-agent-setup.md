...
<Tip>
To use Claude Opus 4.6 or Claude Opus 4.7 with [fast mode](../build-with-claude/build-with-claude-fast-mode.md), pass `model` as an object: `{"id": "claude-opus-4-7", "speed": "fast"}`.
</Tip>
