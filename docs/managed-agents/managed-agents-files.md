...
A new `file_id` will be created that references the instance of the file in the session. These copies do not count against your [storage limits](../build-with-claude/build-with-claude-files.md).
