...
<Tabs>
  <Tab title="Session events">
    ...
    | `session.budget_reached`           | The session reached its [budget](https://platform.claude.com/docs/en/managed-agents/budgets.md) and paused. Fires at most once for each budget value you set; changing the budget arms it again.                                                                                                                                                                                                    |
