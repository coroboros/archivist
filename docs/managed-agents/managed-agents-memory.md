...
Memory stores are attached in the session's `resources[]` array when the [session is created](./managed-agents-sessions.md#creating-a-session). Unlike file resources, memory stores can only be attached at session creation time; adding or removing one from a running session is not supported. You attach memory stores the same way for sessions on cloud and [self-hosted environments](./managed-agents-self-hosted-sandboxes.md#use-memory-stores); self-hosted environments accept only `memory_store` resources.
...
See the [List memories reference](../api/api-beta-memory_stores-memories-list.md) for full parameters and response schema.
...
See the [Retrieve a memory reference](../api/api-beta-memory_stores-memories-retrieve.md) for full parameters and response schema.

### Create a memory

`memories.create` creates a memory at a given `path`. Create does not overwrite; to change an existing memory, use [`memories.update`](./managed-agents-memory.md#update-a-memory).
...
See the [Create a memory reference](../api/api-beta-memory_stores-memories-create.md) for full parameters and response schema.
...
See the [Update a memory reference](../api/api-beta-memory_stores-memories-update.md) for full parameters and response schema.
...
See the [Delete a memory reference](../api/api-beta-memory_stores-memories-delete.md) for full parameters and response schema.
...
See the [List memory versions reference](../api/api-beta-memory_stores-memory_versions-list.md) for full parameters and response schema.
...
See the [Retrieve a memory version reference](../api/api-beta-memory_stores-memory_versions-retrieve.md) for full parameters and response schema.
...
See the [Redact a memory version reference](../api/api-beta-memory_stores-memory_versions-redact.md) for full parameters and response schema.

## Manage memory stores

In addition to [`create`](../api/api-beta-memory_stores-create.md), memory stores support [`retrieve`](../api/api-beta-memory_stores-retrieve.md), [`update`](../api/api-beta-memory_stores-update.md), [`list`](../api/api-beta-memory_stores-list.md), [`archive`](../api/api-beta-memory_stores-archive.md), and [`delete`](../api/api-beta-memory_stores-delete.md).
...
See the [List memory stores reference](../api/api-beta-memory_stores-list.md) for full parameters and response schema.
...
See the [Archive a memory store reference](../api/api-beta-memory_stores-archive.md) for full parameters and response schema.

To permanently remove a store along with all of its memories and versions, use [`memory_stores.delete`](../api/api-beta-memory_stores-delete.md).
