...
Claude Managed Agents connects to [remote MCP servers](../agents-and-tools/agents-and-tools-remote-mcp-servers.md) that expose an HTTP endpoint. The server must support the MCP protocol's streamable HTTP transport.
