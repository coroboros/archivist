...
Once you've defined the tool at the agent level, the agent invokes the tools through the course of a session. See [Session event stream](./managed-agents-events-and-streaming.md#handling-custom-tool-calls) for the full flow.
