...
Event type strings follow a `{domain}.{action}` naming convention. See [Event types](./managed-agents-reference.md#event-types) in the reference for the full catalog.
