...
<CardGroup cols={2}>
  <Card title="Cloud environment setup" icon="settings" href="./managed-agents-environments.md">
  ...
  <Card title="Get started with Agent Skills in the API" icon="graduation-cap" href="../agents-and-tools/agents-and-tools-agent-skills-quickstart.md">
