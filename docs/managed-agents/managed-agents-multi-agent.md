...
The example below extends the [tool confirmation handler](./managed-agents-events-and-streaming.md#tool-confirmation) to route replies. The same pattern applies to `user.custom_tool_result`.
