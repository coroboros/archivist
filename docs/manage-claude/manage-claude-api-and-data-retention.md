...
| [Context management (compaction)](../build-with-claude/build-with-claude-compaction-threshold.md)              | `/v1/messages` (with `context_management`)       | <Eligible>Yes</Eligible>                                | <Eligible status="no">No</Eligible> | Server-side compaction results are returned and round-tripped statelessly through the API response.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
