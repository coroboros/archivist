...
<Check>
  ...
  **Prerequisite:** None for listing chats or remote sessions organization-wide. To filter the chat or session lists to specific users, you need user IDs from [List organization users](./manage-claude-compliance-org-data.md#list-organization-users). The other endpoints on this page take resource IDs directly.
</Check>
