...
For complete parameter details and response schemas, see the [Service accounts API reference](../api/api-beta-organization-service_accounts.md), [Federation issuers API reference](../api/api-beta-organization-federation-issuers.md), and [Federation rules API reference](../api/api-beta-organization-federation-rules.md).
