...
For complete parameter details and response schemas, see the [Service accounts API reference](../api/api-admin-service_accounts.md), [Federation issuers API reference](../api/api-admin-federation_issuers.md), and [Federation rules API reference](../api/api-admin-federation_rules.md).
