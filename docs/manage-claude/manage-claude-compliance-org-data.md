...
| `organization_ids[]` | Filter on [Query the Activity Feed](./manage-claude-compliance-activity-feed.md) and [Retrieve chats and messages](./manage-claude-compliance-content-data.md#retrieve-chats-and-messages) | Accepts `uuid` or the `org_`-prefixed form                                                                                                                |
