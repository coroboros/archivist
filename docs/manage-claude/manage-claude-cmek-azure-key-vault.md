      ...
      <Tab title="Claude Console">
        <Steps>
          <Step title="Register the key with Anthropic">
            ...
            The key details step shows the organization tag. Add it to the key, as [the create step](./manage-claude-cmek-azure-key-vault.md#organization-tag) describes, before you click **Add**.
          </Step>
