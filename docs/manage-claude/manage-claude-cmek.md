...
* The data retention configuration required for your product:
  ...
  * **Claude Platform:** [Zero data retention (ZDR)](./manage-claude-api-and-data-retention.md) turned off for your organization. Organizations with a ZDR arrangement can instead turn on 30-day data retention for at least one workspace; see [Model-specific data retention requirements](./manage-claude-api-and-data-retention.md#model-specific-data-retention-requirements). You can attach a key only to a workspace with data retention enabled.
