...
This page covers managing the people in your **Claude Enterprise** (claude.ai) organization programmatically, using the [Admin API](../api/api-beta-organization.md): list members and look them up by email address, change a member's role, remove members, send and withdraw invites, manage your enterprise's groups and their membership, and read your organization's custom roles. For Claude Console (Claude Platform) organizations, see the [Admin API guide for Claude Console](./manage-claude-admin-api.md).

<Note>
  Group and custom-role requests don't require the `anthropic-beta: ce-user-management-2026-07-13` [beta header](../api/api-beta-headers.md). Requests that still send it are accepted and behave identically.
</Note>
...
Send the `anthropic-version` header on every request; see [API versions](../api/api-versioning.md) for the available versions.
...
Error responses follow the standard shape documented in [Errors](../api/api-errors.md).
...
For complete parameter details and response schemas, see [List users](../api/api-beta-organization-users-list.md) in the API reference.
...
For complete parameter details and response schemas, see [Get user](../api/api-beta-organization-users-retrieve.md) in the API reference.
...
For complete parameter details and response schemas, see [Update user](../api/api-beta-organization-users-update.md) in the API reference.
...
For complete parameter details and response schemas, see [Remove user](../api/api-beta-organization-users-remove.md) in the API reference.
...
For complete parameter details and response schemas, see [Create invite](../api/api-beta-organization-invites-create.md) in the API reference.
...
For complete parameter details and response schemas, see [List invites](../api/api-beta-organization-invites-list.md) in the API reference.
...
For complete parameter details and response schemas, see [Get invite](../api/api-beta-organization-invites-retrieve.md) in the API reference.
...
For complete parameter details and response schemas, see [Delete invite](../api/api-beta-organization-invites-delete.md) in the API reference.
...
For complete parameter details and response schemas, see [List groups](../api/api-beta-organization-rbac_groups-list.md) in the API reference.
...
For complete parameter details and response schemas, see [Get group](../api/api-beta-organization-rbac_groups-retrieve.md) in the API reference.
...
For complete parameter details and response schemas, see [Create group](../api/api-beta-organization-rbac_groups-create.md) in the API reference.
...
For complete parameter details and response schemas, see [Update group](../api/api-beta-organization-rbac_groups-update.md) in the API reference.
...
For complete parameter details and response schemas, see [Delete group](../api/api-beta-organization-rbac_groups-delete.md) in the API reference.
...
For complete parameter details and response schemas, see [List group members](../api/api-beta-organization-rbac_groups-members-list.md) in the API reference.
...
For complete parameter details and response schemas, see [Add group member](../api/api-beta-organization-rbac_groups-members-create.md) in the API reference.
...
For complete parameter details and response schemas, see [Remove group member](../api/api-beta-organization-rbac_groups-members-delete.md) in the API reference.
...
For complete parameter details and response schemas, see [List roles](../api/api-beta-organization-rbac_roles-list.md) in the API reference.
...
For complete parameter details and response schemas, see [Get role](../api/api-beta-organization-rbac_roles-retrieve.md) in the API reference.
...
For complete parameter details and response schemas, see [List role permissions](../api/api-beta-organization-rbac_roles-permissions-list.md) in the API reference.
...
<CardGroup cols={2}>
  <Card title="Create an Admin API key" href="./manage-claude-admin-api-keys.md">
    Where your primary owner creates a scoped key and which scopes to select.
  </Card>

  <Card title="Compliance API" href="./manage-claude-compliance-api.md">
    Audit activity and retrieve or delete user content across your organization.
  </Card>

  <Card title="Analytics APIs" href="./manage-claude-analytics-api.md">
    Per-user and time-bucketed usage and cost reporting for Claude Enterprise.
  </Card>

  <Card title="Spend Limits API" href="./manage-claude-spend-limits-api.md">
