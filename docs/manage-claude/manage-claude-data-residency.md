...
The `inference_geo` parameter is supported on the [Batch API](../build-with-claude/build-with-claude-batch-processing.md). Each request in a batch can specify its own `inference_geo` value.
...
<CardGroup>
  ...
  <Card title="Usage and Cost API" icon="chart" href="./manage-claude-usage-cost-api.md">
