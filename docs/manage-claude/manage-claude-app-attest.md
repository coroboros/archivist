...
Apps use App Attest through the [Claude for Foundation Models](https://github.com/anthropics/ClaudeForFoundationModels) Swift package, which is in beta: it requires the OS 27 betas, and APIs might change before general availability. For the Swift configuration, see [Apple Foundation Models](../general/general-cli-sdks-libraries-libraries-apple-foundation-models.md#app-attest-production).
...
<CardGroup cols={2}>
  <Card title="Apple Foundation Models" icon="code" href="../general/general-cli-sdks-libraries-libraries-apple-foundation-models.md">
    Configure App Attest in the Claude for Foundation Models Swift package
  </Card>

  <Card title="Authentication" icon="lock" href="./manage-claude-authentication.md">
