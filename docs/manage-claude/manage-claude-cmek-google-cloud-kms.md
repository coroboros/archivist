      ...
      <Tab title="Claude Console">
        <Steps>
          <Step title="Register the key with Anthropic">
            ...
            The key details step shows the organization label. Add it to the key, as [the create step](./manage-claude-cmek-google-cloud-kms.md#organization-label) describes, before you click **Add**.
          </Step>
