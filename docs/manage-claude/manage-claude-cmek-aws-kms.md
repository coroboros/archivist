  ...
  <Tab title="Claude Platform">
    ...
    <Steps>
      <Step title="Register the key with Anthropic">
        ...
        <Note>
          For organizations on [Claude Platform on AWS](../build-with-claude/build-with-claude-claude-platform-on-aws.md), the external key endpoints are not yet available. Register, validate, and attach your key in the Claude Console instead.
        </Note>
