...
<CardGroup>
  <Card href="./manage-claude-inference-hooks-configuration.md" title="Configure Inference hooks">
  ...
  <Card href="./manage-claude-inference-hooks-endpoint.md" title="Develop an Inference hooks integration">
