...
| [Plugin marketplace control](./code-plugin-marketplaces.md#managed-marketplace-restrictions) | Restrict which marketplace sources users can add and install from, and reject the CLI flags that sideload plugins, agents, and MCP servers for a single run                                                                                                | `strictKnownMarketplaces`, `blockedMarketplaces`, `disableSideloadFlags`                                     |
