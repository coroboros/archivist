...
| [Model restrictions](./code-model-config.md#restrict-model-selection)                        | Restrict which models users can select, and optionally also apply the allowlist to the Default model selection. See [surface coverage](./code-model-config.md#surface-coverage) for how this setting reaches the CLI, web, and IDE | `availableModels`, `enforceAvailableModels`                                                                  |
