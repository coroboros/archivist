...
<Note>
  Claude Code GitHub Actions is built on top of the [Claude Agent SDK](./code-agent-sdk/overview.md), which enables programmatic integration of Claude Code into your applications. You can use the SDK to build custom automation workflows beyond GitHub Actions.
</Note>
...
The `prompt` input accepts a [skill](./code-skills.md) invocation as well as plain text:
