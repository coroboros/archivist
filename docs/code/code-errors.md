...
These errors come from the [install script](./code-setup.md#install-claude-code) before Claude Code has started. For `command not found`, PATH, permission, and TLS problems during setup, see [Troubleshoot installation and login](./code-troubleshoot-install.md).
