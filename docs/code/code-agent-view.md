...
A dispatched session reads its [settings](./code-settings.md) and [permission mode](./code-permissions.md) from the directory it runs in, the same as if you had started `claude` there.
