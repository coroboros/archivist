...
| `chat:clearInput`     | Ctrl+L                    | Clear prompt input and force a full screen redraw. In [fullscreen rendering](./code-fullscreen.md#clear-the-conversation), press twice within two seconds to run `/clear` |
