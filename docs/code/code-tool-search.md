...
Tool search applies to all registered tools, whether they come from remote MCP servers or [custom SDK MCP servers](./code-agent-sdk/custom-tools.md). When using `auto`, the threshold is based on the combined size of all tool definitions across all servers.
...
For the full set of system prompt options, see [Modifying system prompts](./code-agent-sdk/modifying-system-prompts.md).
...
* [Connect MCP servers](./code-agent-sdk/mcp.md): Connect to external tools via MCP servers
* [Custom tools](./code-agent-sdk/custom-tools.md): Build your own tools with SDK MCP servers
* [TypeScript SDK reference](./code-agent-sdk/typescript.md): Full API reference
* [Python SDK reference](./code-agent-sdk/python.md): Full API reference
