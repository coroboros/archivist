...
1. **Tool needs approval**: Claude wants to use a tool that isn't auto-approved by [permission rules](./code-agent-sdk/permissions.md) or modes. Check `tool_name` for the tool (e.g., `"Bash"`, `"Write"`).
