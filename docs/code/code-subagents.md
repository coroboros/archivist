...
* **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](./code-agent-sdk/typescript.md#agent-definition), [Python](./code-agent-sdk/python.md#agent-definition))
...
In the Python SDK, these field names use camelCase to match the wire format. See the [`AgentDefinition` reference](./code-agent-sdk/python.md#agent-definition) for details.
