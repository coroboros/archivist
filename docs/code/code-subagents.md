...
In the Python SDK, these field names use camelCase to match the wire format. See the [`AgentDefinition` reference](./code-agent-sdk/python.md#agentdefinition) for details.
