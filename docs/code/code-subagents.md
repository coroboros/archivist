...
* **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](./code-agent-sdk/typescript.md#agentdefinition), [Python](./code-agent-sdk/python.md#agentdefinition))
