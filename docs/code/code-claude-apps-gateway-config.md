...
For the client-side Bedrock deployment that the gateway replaces or fronts, see [Claude Code on Amazon Bedrock](./code-amazon-bedrock.md). The gateway-side upstream:
...
For the client-side Foundry deployment, see [Claude Code on Microsoft Foundry](./code-microsoft-foundry.md). The gateway-side upstream:
