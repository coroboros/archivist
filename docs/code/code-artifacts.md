...
| Model provider      | Anthropic API. Not available on [Amazon Bedrock](./code-amazon-bedrock.md), [Google Cloud Vertex AI](./code-google-vertex-ai.md), or [Microsoft Foundry](./code-microsoft-foundry.md).                                                                                                               |
