...
In a terminal Claude Code session, install from the [official Anthropic marketplace](./code-discover-plugins.md#official-anthropic-marketplace):
...
* **Claude desktop app, local or SSH session**: open the [plugin browser](./code-desktop.md#install-plugins) by clicking the **+** button next to the prompt, then **Plugins**, then **Add plugin**
