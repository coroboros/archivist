...
Create a release git tag for the plugin in the current directory. Run from inside the plugin's folder. See [Tag plugin releases](./code-plugin-dependencies.md#tag-plugin-releases-for-version-resolution).
