...
After defining a tool, wrap it in a server with [`createSdkMcpServer`](./code-agent-sdk/typescript.md#create-sdk-mcp-server) (TypeScript) or [`create_sdk_mcp_server`](./code-agent-sdk/python.md#create-sdk-mcp-server) (Python). The server runs in-process inside your application, not as a separate process.
...
See `ToolAnnotations` in the [TypeScript](./code-agent-sdk/typescript.md#tool-annotations) or [Python](./code-agent-sdk/python.md#tool-annotations) reference.
