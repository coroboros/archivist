...
After installing, launch Claude, sign in, and click the **Code** tab. See the [Get started guide](./code-desktop-quickstart.md) for a full walkthrough of your first session.
