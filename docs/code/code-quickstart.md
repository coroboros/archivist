...
| `bypassPermissions` | Runs every tool without prompting, unless an explicit [`ask` rule](./code-agent-sdk/permissions.md#how-permissions-are-evaluated) matches | Sandboxed CI, fully trusted environments  |
