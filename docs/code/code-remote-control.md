...
<Tabs>
  ...
  <Tab title="VS Code">
    In the [Claude Code VS Code extension](./code-vs-code.md), type `/remote-control` or `/rc` in the prompt box, or open the command menu with `/` and select it. Requires Claude Code v2.1.79 or later.
