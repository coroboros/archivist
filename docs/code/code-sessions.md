...
* **Recover from a limit.** The first run ended with `error_max_turns` or `error_max_budget_usd` (see [Handle the result](./code-agent-sdk/agent-loop.md#handle-the-result)); resume with a higher limit.
