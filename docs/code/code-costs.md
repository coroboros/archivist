...
On Bedrock, Vertex, and Foundry, Claude Code does not send metrics from your cloud. Organizations that already route Claude Code through an [LLM gateway](./code-llm-gateway.md) can track spend there, since the gateway sees every request.
