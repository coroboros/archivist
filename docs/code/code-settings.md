...
| `availableModels`                 | Restrict which models users can select for the main session, [subagents](./code-sub-agents.md), and the [advisor](./code-advisor.md). See [Restrict model selection](./code-model-config.md#restrict-model-selection). See `enforceAvailableModels` to also constrain the default model                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `["sonnet", "haiku"]`                                                                                                           |
