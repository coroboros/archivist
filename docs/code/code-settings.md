...
| `alwaysThinkingEnabled`           | Enable [extended thinking](./code-model-config.md#extended-thinking) by default for all sessions. Typically configured via the `/config` command rather than editing directly. To force thinking off regardless of this setting, set [`MAX_THINKING_TOKENS=0`](./code-env-vars.md) in `env`. On [third-party providers](./code-third-party-integrations.md) this omits the `thinking` parameter instead, and adaptive-reasoning models may still think                                                                                                                                                                                                                                                                                                                                                                                                              | `true`                                                                                                                         |
...
| `availableModels`                 | Restrict which models users can select via `/model`, `--model`, or `ANTHROPIC_MODEL`. Does not affect the Default option. See [Restrict model selection](./code-model-config.md#restrict-model-selection)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `["sonnet", "haiku"]`                                                                                                          |
