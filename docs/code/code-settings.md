...
| `effortLevel`                     | Persist the [effort level](./code-model-config.md#adjust-effort-level) across sessions. Accepts `"low"`, `"medium"`, `"high"`, or `"xhigh"`. Written automatically when you run `/effort` with one of those values. See [Adjust effort level](./code-model-config.md#adjust-effort-level) for supported models                                                                                                                                                                                                                                                       | `"xhigh"`                                                                                                                      |
...
| `tui`                             | Terminal UI renderer. Use `"fullscreen"` for the flicker-free [alt-screen renderer](./code-fullscreen.md) with virtualized scrollback. Use `"default"` for the classic main-screen renderer. Set via `/tui`                                                                                                                                                                                                                                                                                                                                                    | `"fullscreen"`                                                                                                                 |
