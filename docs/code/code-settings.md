...
| `feedbackSurveyRate`              | Probability (0–1) that the [session quality survey](./code-data-usage.md#session-quality-surveys) appears when eligible. Set to `0` to suppress entirely, or set [`CLAUDE_CODE_DISABLE_FEEDBACK_SURVEY`](./code-env-vars.md) in `env`. Useful when using Bedrock, Vertex, or Foundry where the default sample rate does not apply                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `0.05`                                                                                                                          |
