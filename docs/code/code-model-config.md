...
* **Subagent models**: the `model` field in [subagent](./code-sub-agents.md#choose-a-model) frontmatter, the Agent tool's `model` parameter, the model picker in `/agents`, and `CLAUDE_CODE_SUBAGENT_MODEL`
