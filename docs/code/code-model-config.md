...
| Disable regardless of effort   | Set [`MAX_THINKING_TOKENS=0`](./code-env-vars.md). Other values apply only with a [fixed thinking budget](#adaptive-reasoning-and-fixed-thinking-budgets) |
