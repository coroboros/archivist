...
* **Create new**: add a Markdown file at `~/.claude/output-styles/` or `.claude/output-styles/`; see [Create a custom output style](./code-output-styles.md#create-a-custom-output-style) for the format
...
* [Output styles](./code-output-styles.md) - Complete output styles documentation
* [TypeScript SDK guide](./code-agent-sdk/typescript.md) - Complete SDK usage guide
* [Configuration guide](./code-settings.md) - General configuration options
