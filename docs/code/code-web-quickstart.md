...
| **[Permission modes](./code-permission-modes.md)** | Auto accept edits, Plan                                                                                         | Ask, Auto accept edits, Plan | All modes              | Depends on session type     |
