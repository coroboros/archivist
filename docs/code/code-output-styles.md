...
* **Proactive**: Claude executes immediately, makes reasonable assumptions
  ...
  [auto mode](./code-permission-modes.md#eliminate-prompts-with-auto-mode) without
...
session. Use a [subagent](./code-sub-agents.md) when you want a separately scoped
