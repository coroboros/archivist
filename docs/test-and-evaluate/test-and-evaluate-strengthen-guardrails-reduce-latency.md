...
For a more in-depth understanding of these terms, check out the [glossary](../about-claude/about-claude-glossary.md).
...
For more details about model metrics, see the [models overview](../about-claude/about-claude-models-overview.md) page.
...
* **Ask for shorter responses:** Ask Claude directly to be concise. If Claude is outputting unwanted length, ask Claude to [curb its chattiness](../build-with-claude/build-with-claude-prompt-engineering-claude-prompting-best-practices.md#be-clear-and-direct).
  <Tip>
...
* **Experiment with temperature:** The `temperature` [parameter](../api/api-messages-create.md) controls the randomness of the output. Lower values (for example, 0.2) can sometimes lead to more focused and shorter responses, while higher values (for example, 0.8) might result in more diverse but potentially longer outputs.
...
Visit [Streaming messages](../build-with-claude/build-with-claude-streaming.md) to learn about how you can implement streaming for your use case.
...
<CardGroup cols={2}>
  <Card title="Reduce hallucinations" icon="shield" href="./test-and-evaluate-strengthen-guardrails-reduce-hallucinations.md">
  ...
  <Card title="Streaming messages" icon="bolt" href="../build-with-claude/build-with-claude-streaming.md">
