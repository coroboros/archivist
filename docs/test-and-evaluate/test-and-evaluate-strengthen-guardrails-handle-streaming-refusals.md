...
* **Newer models return more detail.** On Claude Fable 5, a refusal also includes a `stop_details` object that identifies the policy category behind the decline. See [Refusals and fallback](../build-with-claude/build-with-claude-refusals-and-fallback.md#refusal-response) for the full response shape.
