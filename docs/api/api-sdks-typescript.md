...
This SDK provides support for the [Message Batches API](../build-with-claude/build-with-claude-batch-processing.md) under the `client.messages.batches` namespace.
