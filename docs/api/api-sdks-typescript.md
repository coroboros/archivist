...
For more details on tool use, see the [tool use overview](../agents-and-tools/agents-and-tools-tool-use-overview.md).
...
This SDK provides support for tool use, aka function calling. More details can be found in the [tool use overview](../agents-and-tools/agents-and-tools-tool-use-overview.md).
...
For the Claude API's built-in remote MCP server support, see [MCP Connector](../agents-and-tools/agents-and-tools-mcp-connector.md).
