...
<Note>
**New to Claude?** For direct model access, start with [Get started](./api-get-started.md) and [Working with Messages](../developer/developer-build-with-claude-working-with-messages.md). For managed agent infrastructure, see the [Claude Managed Agents quickstart](../developer/developer-managed-agents-quickstart.md).
</Note>
...
- **[Agents API](../developer/developer-managed-agents-agent-setup.md)**: Define reusable, versioned agent configurations for Claude Managed Agents (`POST /v1/agents`, `GET /v1/agents`)
- **[Sessions API](../developer/developer-managed-agents-sessions.md)**: Run stateful agent sessions in managed cloud containers (`POST /v1/sessions`, `GET /v1/sessions/{id}/stream`)
- **[Environments API](../developer/developer-managed-agents-environments.md)**: Configure container templates for agent sessions (`POST /v1/environments`, `GET /v1/environments`)
...
|----------|----------|---------------|
| Amazon Bedrock | AWS | [Claude in Amazon Bedrock](../developer/developer-build-with-claude-claude-in-amazon-bedrock.md) |
...
<Note>
Claude Managed Agents is available only through the direct Claude API. For feature availability across platforms, see the [Features overview](../developer/developer-build-with-claude-overview.md).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Claude Managed Agents reference" icon="brain" href="../developer/developer-managed-agents-sessions.md">
