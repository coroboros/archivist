...
When receiving a [streaming](../build-with-claude/build-with-claude-streaming.md) response via SSE, it's possible that an error can occur after returning a 200 response, in which case error handling wouldn't follow these standard mechanisms.
