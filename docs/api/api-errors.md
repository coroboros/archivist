...
* 504 - `timeout_error`: The request timed out while processing. Consider using [streaming](../developer/developer-build-with-claude-streaming.md) for long-running requests.
