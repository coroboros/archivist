...
You can check your current rate limits and behavior in the [Claude Console](/settings/limits), or read the configured limits programmatically with the [Rate Limits API](../developer/developer-build-with-claude-rate-limits-api.md).
...
[Claude Managed Agents](../developer/developer-managed-agents-overview.md) endpoints are rate-limited per organization. These limits are separate from the Messages API rate limits above.
...
To read your current organization and workspace rate limits programmatically, use the [Rate Limits API](../developer/developer-build-with-claude-rate-limits-api.md).
