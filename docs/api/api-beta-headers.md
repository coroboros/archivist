...
See the [Managed Agents overview](../managed-agents/managed-agents-overview.md) and the [MCP tunnels reference](../agents-and-tools/agents-and-tools-mcp-tunnels-reference.md#tunnels-api) for details.
