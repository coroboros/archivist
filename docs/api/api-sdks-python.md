...
This SDK provides support for tool use, also known as function calling. More details can be found in the [tool use overview](../agents-and-tools/agents-and-tools-tool-use-overview.md).
