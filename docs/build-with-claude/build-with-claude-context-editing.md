...
| **Client-side** | SDK | Compaction | Available in [Python, TypeScript, and Ruby SDKs](../api/api-client-sdks.md) when using [`tool_runner`](../agents-and-tools/agents-and-tools-tool-use-tool-runner.md). Generates a summary and replaces full conversation history. See [Client-side compaction](#client-side-compaction-sdk) below. |
...
<Note>
Compaction is available in the [Python, TypeScript, and Ruby SDKs](../api/api-client-sdks.md) when using the [`tool_runner` method](../agents-and-tools/agents-and-tools-tool-use-tool-runner.md).
</Note>
...
<Note>
The Go SDK's `tool_runner` does not support `compaction_control`. Use [server-side compaction](./build-with-claude-compaction.md) instead, which handles compaction on Anthropic's servers without SDK-side integration.
</Note>
...
<Note>
The Java SDK's `tool_runner` does not support `compaction_control`. Use [server-side compaction](./build-with-claude-compaction.md) instead, which handles compaction on Anthropic's servers without SDK-side integration.
</Note>
...
<Note>
The PHP SDK's `tool_runner` does not support `compaction_control`. Use [server-side compaction](./build-with-claude-compaction.md) instead, which handles compaction on Anthropic's servers without SDK-side integration.
</Note>
...
<Note>
The Go SDK's `tool_runner` does not support `compaction_control`. Use [server-side compaction](./build-with-claude-compaction.md) instead.
</Note>
...
<Note>
The Java SDK's `tool_runner` does not support `compaction_control`. Use [server-side compaction](./build-with-claude-compaction.md) instead.
</Note>
...
<Note>
The PHP SDK's `tool_runner` does not support `compaction_control`. Use [server-side compaction](./build-with-claude-compaction.md) instead.
</Note>
