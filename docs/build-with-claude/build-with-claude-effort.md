...
<Tip>
  For how effort interacts with thinking and which control to reach for, see [Thinking and effort](./build-with-claude-thinking.md#thinking-and-effort). Where adaptive thinking is available, effort is the recommended way to control thinking depth.
</Tip>
