...
For prompting guidance on using context awareness, see [Prompting best practices](./build-with-claude-prompt-engineering-claude-prompting-best-practices.md#context-awareness-and-multi-window-workflows).
