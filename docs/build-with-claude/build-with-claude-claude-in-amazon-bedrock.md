...
Model IDs in Claude in Amazon Bedrock carry an `anthropic.` provider prefix. Model capabilities and behaviors are documented on the [Models overview](../general/general-models-overview.md) page.

| Model                 | Model ID                        | Access                                                                                              |
| --------------------- | ------------------------------- | --------------------------------------------------------------------------------------------------- |
| Claude Fable 5.1      | anthropic.claude-fable-5-1      | Open                                                                                                |
| Claude Fable 5        | anthropic.claude-fable-5        | Open                                                                                                |
| Claude Opus 5.5       | anthropic.claude-opus-5-5       | See [Access](./build-with-claude-claude-in-amazon-bedrock.md#access) |
...
* [Messages API](../api/api-messages-create.md) (`/anthropic/v1/messages`)
