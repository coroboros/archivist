...
* Thinking isn't compatible with `temperature` or `top_k` modifications or with [forced tool use](../agents-and-tools/agents-and-tools-tool-use-define-tools.md#forcing-tool-use).
