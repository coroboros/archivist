...
|---|---|---|
| Claude Fable 5<br />Claude Mythos 5 | Not supported (400 error) | [Adaptive thinking](./build-with-claude-adaptive-thinking.md), always on; use [effort](./build-with-claude-effort.md) to control depth |
...
| Claude Opus 4.6 | [Deprecated](./build-with-claude-overview.md#feature-availability) | [Adaptive thinking](./build-with-claude-adaptive-thinking.md) with [effort](./build-with-claude-effort.md) |
| Claude Sonnet 4.6 | [Deprecated](./build-with-claude-overview.md#feature-availability) | [Adaptive thinking](./build-with-claude-adaptive-thinking.md) with [effort](./build-with-claude-effort.md) |
...
For more information about the response format of extended thinking, see the [Messages API Reference](../api/api-messages-create.md).
...
<Warning>
`budget_tokens` is [deprecated](./build-with-claude-overview.md#feature-availability) on Claude Opus 4.6 and Claude Sonnet 4.6 and will be removed in a future model release. Use [adaptive thinking](./build-with-claude-adaptive-thinking.md) with the [effort parameter](./build-with-claude-effort.md) to control thinking depth instead.
</Warning>
...
Extended thinking can be used alongside [tool use](../agents-and-tools/agents-and-tools-tool-use-overview.md), allowing Claude to reason through tool selection and results processing.
...
Which blocks are kept depends on the model. See [Thinking block preservation by model](#thinking-block-preservation-in-claude-opus-45-and-later) for the per-class defaults. To override the default, use the [`clear_thinking_20251015` context-editing strategy](./build-with-claude-context-editing.md#thinking-block-clearing).
</Tip>
...
|---|---|
| Claude Fable 5<br />Claude Mythos 5 | Automatic with [adaptive thinking](./build-with-claude-adaptive-thinking.md). Inter-tool reasoning moves into thinking blocks. No beta header needed. |
...
| Claude Opus 4.5 | Add the `interleaved-thinking-2025-05-14` [beta header](../api/api-beta-headers.md) to your API request. |
...
The `data` field is opaque and encrypted. Like the `signature` field on regular thinking blocks, you should pass `redacted_thinking` blocks back to the API unchanged when continuing a multi-turn conversation with [tools](./build-with-claude-extended-thinking.md#extended-thinking-with-tool-use).
...
|---|---|---|---|---|
| Claude Fable 5<br />Claude Mythos 5 | Not supported | Omitted by default<sup>1</sup> | Automatic<sup>2</sup> | See [Adaptive thinking](./build-with-claude-adaptive-thinking.md) |
...
_<sup>2</sup> With [adaptive thinking](./build-with-claude-adaptive-thinking.md). The `interleaved-thinking-2025-05-14` beta header is not needed on these models and is safely ignored if included._<br/>
...
- Thinking isn't compatible with `temperature` or `top_k` modifications as well as [forced tool use](../agents-and-tools/agents-and-tools-tool-use-define-tools.md#forcing-tool-use).
...
<CardGroup cols={3}>
  <Card title="Adaptive thinking" icon="brain" href="./build-with-claude-adaptive-thinking.md">
