...
* Check whether it's your Default Workspace's ID by passing it to [Get Workspace](../api/api-beta-organization-workspaces-retrieve.md) with an [Admin API key](../manage-claude/manage-claude-admin-api-keys.md): the Default Workspace comes back with `"name": "Default"`, even though [List Workspaces](../api/api-beta-organization-workspaces-list.md) omits it
