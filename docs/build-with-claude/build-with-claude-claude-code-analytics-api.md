...
<Note>
  **Claude Enterprise organizations:** Claude Code activity for claude.ai users is reported by the Claude Enterprise Analytics API, which uses an Analytics API key instead of an Admin API key. See [Analytics APIs](../manage-claude/manage-claude-analytics-api.md) to find which API and key type your organization needs.
</Note>
...
For complete parameter details and response schemas, see the [Claude Code Analytics API reference](../api/api-beta-organization-usage_report-retrieve_claude_code.md).
...
* [Usage and Cost API](../manage-claude/manage-claude-usage-cost-api.md) - Track API usage across all Anthropic services
* [Compliance API](../manage-claude/manage-claude-compliance-api.md) - Retrieve audit and activity data
