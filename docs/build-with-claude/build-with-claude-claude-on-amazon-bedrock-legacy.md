...
Calling Claude through Bedrock slightly differs from how you would call Claude on the Claude API directly. This guide walks you through completing an API call to Claude on Bedrock using one of Anthropic's [client SDKs](../general/general-cli-sdks-libraries-overview.md).
...
Anthropic's [client SDKs](../general/general-cli-sdks-libraries-overview.md) support Bedrock. You can also use an AWS SDK like `boto3` directly.
...
| Claude Opus 4.1 ([deprecated](../about-claude/about-claude-model-deprecations.md))  | `anthropic.claude-opus-4-1-20250805-v1:0`   | No       | Yes  | No   | No   | No     |
...
See the [client SDKs](../general/general-cli-sdks-libraries-overview.md) for more details, and the [official Bedrock documentation](https://docs.aws.amazon.com/bedrock/).
...
* **Anthropic pricing details:** [Cloud platform pricing](../about-claude/about-claude-pricing.md#cloud-platform-pricing)
