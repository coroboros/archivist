...
- **[Evaluation tool](../test-and-evaluate/test-and-evaluate-eval-tool.md):** Allows you to easily test, scale, and track versions of your prompts by separating the variable and fixed portions of your prompt template
...
<Tip>To level up your prompt variables, wrap them in [XML tags](./build-with-claude-prompt-engineering-claude-prompting-best-practices.md#structure-prompts-with-xml-tags) for clearer structure.</Tip>
...
Don't have examples yet? Use the [Test Case Generator](../test-and-evaluate/test-and-evaluate-eval-tool.md#creating-test-cases) to:
...
<CardGroup cols={2}>
  <Card title="Start prompt engineering" icon="link" href="./build-with-claude-prompt-engineering-claude-prompting-best-practices.md">
    Learn core techniques with worked examples.
  </Card>
  <Card title="Test your prompts" icon="link" href="../test-and-evaluate/test-and-evaluate-eval-tool.md">
