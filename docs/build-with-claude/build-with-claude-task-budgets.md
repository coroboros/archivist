---
title: "When to use task budgets"
...
The minimum accepted `task_budget.total` is **20,000 tokens** on every model that supports task budgets (see [Feature support](./build-with-claude-task-budgets.md#feature-support)). Smaller values return a 400 error.
