...
The minimum accepted `task_budget.total` is model-specific. On every model that supports task budgets (see [Feature support](./build-with-claude-task-budgets.md#feature-support)) it is **20,000 tokens**, and smaller values return a 400 error.
