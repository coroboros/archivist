...
* [Thinking blocks from Claude Fable 5](./build-with-claude-adaptive-thinking.md#thinking-output-on-claude-fable-5-and-claude-mythos-5) are handled for you: the middleware strips them from the retry and manages them in conversation history on later requests.
...
<Accordion title="Writing the retry yourself">
  ...
  <Steps>
    ...
    <Step title="Re-send on a fallback model">
      ...
      * **Not redeeming a credit:** you can first strip the [thinking blocks from Claude Fable 5](./build-with-claude-adaptive-thinking.md#thinking-output-on-claude-fable-5-and-claude-mythos-5) out of the conversation history. Other models ignore them, and stripping keeps cross-model requests minimal.
