...
If not, we highly suggest you spend time establishing that first. Check out [Define success criteria and build evaluations](../test-and-evaluate/test-and-evaluate-develop-tests.md) for tips and guidance.
