...
<CardGroup cols={2}>
  <Card title="Get started with Agent Skills" icon="rocket" href="../agents-and-tools/agents-and-tools-agent-skills-quickstart.md">
    Create your first Skill
  </Card>

  <Card title="Create custom Skills" icon="hammer" href="../agents-and-tools/agents-and-tools-agent-skills-best-practices.md">
