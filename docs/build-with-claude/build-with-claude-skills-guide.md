...
| **Management**     | Pre-built and maintained by Anthropic      | Upload and manage through the [Skills API](https://platform.claude.com/docs/en/api/skills/create-skill.md) |
...
<CardGroup cols={2}>
  <Card title="API Reference" icon="book" href="https://platform.claude.com/docs/en/api/skills/create-skill.md">
    Complete API reference with all endpoints
  </Card>

  <Card title="Authoring Guide" icon="edit" href="../agents-and-tools/agents-and-tools-agent-skills-best-practices.md">
