...
<CardGroup cols={2}>
  <Card
    ...
    icon="rocket"
    href="../agents-and-tools/agents-and-tools-agent-skills-quickstart.md"
  >
  ...
  <Card
    ...
    icon="hammer"
    href="../agents-and-tools/agents-and-tools-agent-skills-best-practices.md"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="terminal"
    href="../agents-and-tools/agents-and-tools-tool-use-code-execution-tool.md"
  >
