...
- **CI**: GitHub Actions workflow (`.github/workflows/update-docs.yml`) runs every 12h, fetches docs, auto-versions with `pnpm version patch`, commits, tags, creates GitHub releases, and optionally notifies via Telegram
